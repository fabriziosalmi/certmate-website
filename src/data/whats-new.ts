 ...
 *
 * The lead card is the latest release line. Descriptions are drawn from RELEASE_NOTES.md in the app
...
export const updates: UpdateCard[] = [
  ...
  },
  {
    ...
    icon: 'fa6-solid:key',
    title: 'v2.32.0-2.32.2 - mechanisms that were published and did nothing, and two things the dashboard said that were not true',
    description:
  ...
  },
  {
    ...
    title: 'v2.30.0 - credentials that can live somewhere else, and a build that is the same twice',
    description:
  ...
  },
  {
    ...
    title: 'v2.29.0 - certificates whose private key never reaches CertMate, and deploy hooks that can wait',
    description:
  ...
  },
  {
    ...
    title: 'v2.28.0 - two silent failures, and two things you can now do without curl',
    description:
  ...
  {
    badge: 'security',
    badgeLabel: 'v2.27.0 - v2.27.1',
    icon: 'fa6-solid:box-archive',
    title: 'v2.27.0-2.27.1 - backups you can actually restore from',
    description:
